...
namespace Lynx.Tests.UnitTests.Core.Operators
{
    ...
    public class Addition_Specs
    {
        ...
        public void Setup()
        {
            SUT = new Addition(new Variable("a"), new Variable("b"));
        }
        ...
        public void constructor_should_set_left_number()
        {
            ...
            // When 
            SUT = new Addition(nbr, new Variable("b"));
        ...
        public void constructor_should_set_right_number()
        {
            ...
            // When 
            SUT = new Addition(new Variable("b"), nbr);
        ...
        {
            var ex = Assert.Throws<ArgumentNullException>(() => new Addition(null, new Variable("a")));
        ...
        {
            var ex = Assert.Throws<ArgumentNullException>(() => new Addition(new Variable("a"), null));
