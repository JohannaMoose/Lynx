...
namespace Lynx.Tests.UnitTests.Core.Conditions
{
    ...
    public class Equals_Specs
    {
        ...
        public void Setup()
        {
            SUT = new Equals(new RealNumber(1), new RealNumber(2));
        }
        ...
        public void constructor_should_throw_if_left_number_is_null()
        {
            ...
            // Then
            var ex = Assert.Throws<ArgumentNullException>(() => new Equals(null, new RealNumber(1)));
        ...
        public void constructor_should_throw_if_right_number_is_null()
        {
            ...
            // Then
            var ex = Assert.Throws<ArgumentNullException>(() => new Equals(new RealNumber(1), null));
        ...
        [Test]
        public void conditionMeet_should_return_true_if_both_numbers_have_same_value()
        {
            // Given 
            SUT = new Equals(new RealNumber(1), new RealNumber(1));
        ...
        [Test]
        public void conditionMeet_should_return_false_if_both_numbers_dont_have_same_value()
        {
            // Given 
            SUT = new Equals(new RealNumber(1), new RealNumber(2));
