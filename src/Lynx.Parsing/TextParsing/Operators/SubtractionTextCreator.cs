...
namespace Lynx.Parsing.TextParsing.Operators
{
    ...
    /// </summary>
    internal class SubtractionTextCreator : OperatorCreator
    {
        /// <summary>
        ...
        {
            if(nbrs.Length != 2)
                throw  new ArgumentException("Subtraction needs exactly 2 numbers, that is not what was provided");

            return new Subtraction(nbrs[1], nbrs[0]);
        }
    }
}